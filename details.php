        ...
        <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4">
                ...
                <li class="mb-2">
                    ...
                    <span class="text-xs bg-blue-500 text-white rounded-full px-2 py-1 ml-2"><?php echo $job['type']; ?></span>
                </li>
...
<section class="container mx-auto p-4">
    ...
    <a href="mailto:<?php echo $job['contact']; ?>" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
        Apply Now
    </a>
</section>
